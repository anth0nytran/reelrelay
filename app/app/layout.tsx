...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex bg-surface">
      ...
      <aside
        className={clsx(
          'fixed inset-y-0 left-0 z-50 w-72 border-r border-surface-border bg-surface transform transition-transform duration-300 lg:translate-x-0 lg:static lg:h-screen lg:shrink-0',
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col p-4 gap-8 overflow-y-auto">
            ...
            <Link 
              href="/app/posts/new" 
              className="btn-primary w-full shadow-lg shadow-brand-primary/10 justify-start px-4 h-12 rounded-xl"
              onClick={() => setMobileMenuOpen(false)}
            >
